...
function calculateDimensions() {
    ...
    // Logic for graph height fitting
    ...
    if (calculatedGraphHeight < 100 && window.innerWidth > 900) {
        // Too small, adjust scale logic? or just min clamp?
        // Let's rely on the scroll constraint check below
    }
    ...
    if (canvasHeight > targetHeight && window.innerWidth > 900) {
        ...
        // BASE_HEIGHT sim + 250 graph + 20 gap
